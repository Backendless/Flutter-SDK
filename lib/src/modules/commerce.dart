...
class BackendlessCommerce {
  ...
  void cancelPlaySubscription(String packageName, String subscriptionId, String token) async =>
  ...
  Future<GooglePlaySubscriptionStatus> getPlaySubscriptionsStatus(String packageName, String subscriptionId, String token) async =>
  ...
  Future<GooglePlayPurchaseStatus> validatePlayPurchase(String packageName, String productId, String token) async =>
