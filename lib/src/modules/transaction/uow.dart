...
class UnitOfWork
{
  ...
  UnitOfWork() {
    ...
    OpResultIdGenerator opResultIdGenerator = new OpResultIdGenerator( _opResultIdStrings );
    ...
    _relationOperation = new RelationOperation( _operations, opResultIdGenerator );
  ...
  OpResult addToRelation(dynamic parent, String columnName, dynamic children, [String parentTable]) {
    return _relationOperation.addOperation(OperationType.ADD_RELATION, parent, columnName, children, parentTable);
  }

  OpResult setRelation(dynamic parent, String columnName, dynamic children, [String parentTable]) {
    return _relationOperation.addOperation(OperationType.SET_RELATION, parent, columnName, children, parentTable);
  }
