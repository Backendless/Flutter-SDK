  ...
  Future<dynamic> handleMethodCall(MethodCall call) {
    switch (call.method) {    
      ...
      case "Backendless.Cache.delete":
        return promiseToFuture(
          delete(call.arguments['key'])
        );
      case "Backendless.Cache.expireAt":
        int timestamp = call.arguments['timestamp'];
        if (timestamp == null) timestamp = (call.arguments['date'] as DateTime).millisecondsSinceEpoch;
        return promiseToFuture(
          expireAt(call.arguments['key'], timestamp)
        );
      ...
      case "Backendless.Cache.put":
        return promiseToFuture(
          put(call.arguments['key'], jsonEncode(call.arguments['object']), call.arguments['timeToLive'])
        );
      default:
