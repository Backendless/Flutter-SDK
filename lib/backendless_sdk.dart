...
class Backendless {
  ...
  static Future<void> initApp(String applicationId, String androidApiKey, String iosApiKey) {
    String apiKey;
    if (Platform.isAndroid) apiKey = androidApiKey;
    else if (Platform.isIOS) apiKey = iosApiKey;
    return _channel.invokeMethod('Backendless.initApp', <String, dynamic> {
      'applicationId': applicationId,
      'apiKey': apiKey
    });
  }

  static Future<String> getApiKey() => _channel.invokeMethod("Backendless.getApiKey");

  static Future<String> getApplicationId() => _channel.invokeMethod("Backendless.getApplicationId");

  static Future<int> getNotificationIdGeneratorInitValue() => _channel.invokeMethod("Backendless.getNotificationIdGeneratorInitValue");

  static Future<String> getPushTemplatesAsJson() => _channel.invokeMethod("Backendless.getPushTemplatesAsJson");

  static Future<String> getUrl() => _channel.invokeMethod("Backendless.getUrl");

  static Future<bool> isInitialized() => _channel.invokeMethod("Backendless.isInitialized");
  ...
  static Future<void> setUIState(String state) =>
